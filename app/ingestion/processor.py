...
"""
importing functions, objects in different files
"""

from app.config import Settings
from app.ingestion.chunking.splitter import chunk_text
from app.ingestion.loaders.htmll import parse_html
...
"""
logfire is for observability and configure is to setup for monitoring &
service name is a tag that specifies app.
"""

logfire.configure(service_name="enterprise-ingestion-service")

"""
After chunkiing we are going to store embedded data in cloud but to have a local copy,
the PROCESSED_DATA_DIR is created.
"""
...
"""This function is created to Save parsed chunk metadata as JSON in processed_data/<source_type>/."""
