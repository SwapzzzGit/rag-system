...
# # Write a function that returns "No text" if the input contains only spaces or is empty. Otherwise return "Text found".
...
# # Write a function that checks whether a string starts with "#".

# # text = "#"


# # def check_fn(text: str):
# #     if text.startswith("#"):
...
# # Write a function that counts how many paragraphs exist.
# # A paragraph is separated by two newlines (\n\n).

# # text = "One\n\nTwo\n\nThree"


# # def check_para(text: str):
...
# # Question 4: Check Chunk Size
# # Write a function that receives a paragraph.
...
# # Q. Suppose you already have a list of paragraphs: Write code that creates a new list containing only the non-empty paragraphs

# # paragraphs = ["Hello", "", "     ", "Python is awesome", " "]
